...
<?php $page_title = "All Memes"; ?>
<?php $masonry = "load"; ?>
<?php include 'header.php'; ?>
<?php include 'navbar.php'; ?>
<?php
// get all memes
$stmt = $pdo->prepare('SELECT users.username, users.id, memes.path, memes.name, memes.created, memes.id AS meme_id FROM users INNER JOIN memes ON users.id = memes.user_id ORDER BY memes.created DESC');
$stmt->execute();
$memes = $stmt->fetchAll();
